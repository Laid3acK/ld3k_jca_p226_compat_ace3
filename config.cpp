...
class CfgMagazineWells
{
    ...
    class JCA_P226_9x19 // Weapon initSpeed -1 with ACE_barrelLength 112mm (4.4"), 378m/s - 311m/s at ICAO standart conditions (15°C, 1013.25 hPa, 0%) according to JCA_15Rnd_9x19_P226_FMJ_Mag, JCA_15Rnd_9x19_P226_JHP_Mag and JCA_15Rnd_9x19_P226_SUB_Mag initSpeed
    {
        JCA_Magazines[]=
        {
...
class CfgWeapons
{
    ...
    class JCA_hgun_P226_base_F: Pistol_Base_F // U.S. Navy SEALs P226 MK25 https://www.sigsauer.com/p226-mk25-full-size.html
    {
        ...
        initSpeed=-1; // 378m/s - 311m/s, 112mm barrel, according to ACE_muzzleVelocities at ICAO conditions (15°C, 1013.25hPa, 0%), JCA 380
        magazines[]=
